...
export function Dashboard() {
  ...
  const colors = {
    salesOverview: ["#3b82f6", "#10b981", "#ef4444"],
    productPerformance: ["#8b5cf6", "#6366f1", "#4f46e5"],
    categories: ["#3b82f6", "#64748b", "#10b981", "#f59e0b", "#94a3b8"],
    regional: ["#059669", "#10b981", "#34d399", "#6ee7b7", "#a7f3d0"],
    demographics: ["#f97316", "#f59e0b", "#eab308", "#facc15", "#fde047"],
  };
